...
/*
#cgo CFLAGS: -I${SRCDIR}/../../../build/libghostty-vt/vendor/linux-arm64-gnu/include
#cgo LDFLAGS: ${SRCDIR}/../../../build/libghostty-vt/vendor/linux-arm64-gnu/libghostty-vt.a -lm -lpthread
*/
import "C"
