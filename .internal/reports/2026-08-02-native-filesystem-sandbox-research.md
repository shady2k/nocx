...
- **Status:** evidence ledger for `.internal/specs/2026-08-02-native-filesystem-sandbox-design.md`,
  ADR-0036, and `.internal/plans/2026-08-02-native-filesystem-sandbox-v1.md`
...
| 11  | Proposed Docker/OCI path                                 | **Reject**                        | `docs/plans/docker-sandbox/*` is proposal-only in termic and container runtime is not selected for nocx (ADR-0036 "Alternatives")                                                                                                                                        |
