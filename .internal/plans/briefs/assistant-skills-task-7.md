...
3. .internal/plans/2026-09-01-assistant-skills.md — read the header and the
   "Global Constraints" section (lines 1-30), then "### Task 7" in full
   (lines 1148-1201). That is your task; it contains the code for every step.

Your bead id is nocx-m1k3i. Every commit subject must end with "(nocx-m1k3i)".
...
- Do not widen scope beyond Task 7. If you find a defect outside it, put it in
