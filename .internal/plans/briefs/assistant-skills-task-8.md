...
3. .internal/plans/2026-09-01-assistant-skills.md — read the header and the
   "Global Constraints" section (lines 1-30), then "### Task 8" in full
   (lines 1202-1246). That is your task; it contains the code for every step.

Your bead id is nocx-fyc55. Every commit subject must end with "(nocx-fyc55)".
...
- Do not widen scope beyond Task 8. If you find a defect outside it, put it in
