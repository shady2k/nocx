...
// nocx-szb40.1 (spike/vt-agreement/REPORT.md): it is the only candidate that
// reproduces xterm.js's COLUMN GEOMETRY across a double-width character, and
// both powers above are positional.
package panegrid
