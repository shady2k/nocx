...
func TestNotifyCatalogue_OverTheWireConformsToContract(t *testing.T) {
	...
	want := []catalogueKind{
		...
		{ID: "workerUndispatched", Kind: "workers.undispatched", Label: "A worker is waiting for judgement", Description: "nocx's own worker record has a worker's result that its coordinator was not reached about."},
