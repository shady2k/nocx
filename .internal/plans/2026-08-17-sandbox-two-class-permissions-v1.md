...
created: 2026-08-17
bead: nocx-83oba
adr: docs/decisions/0036-sandbox-two-class-directory-grants.md
...
- Failure class follows provenance: request/delta `-32602`, persisted baseline `-32012`.
...
ADR-0036 and the new design spec are the authoritative delta; ADR-0034 remains append-only history. Update AD-11 to cite ADR-0036 and name both baselines/classes. Keep ADR-0033/0035 and vision scope unchanged.
