...
3. .internal/plans/2026-09-01-assistant-skills.md — read the header and the
   "Global Constraints" section (lines 1-30), then "### Task 4" in full
   (lines 857-954). That is your task; it contains the code for every step.

Your bead id is nocx-zuf28. Every commit subject must end with "(nocx-zuf28)".
...
- Do not widen scope beyond Task 4. If you find a defect outside it, put it in
