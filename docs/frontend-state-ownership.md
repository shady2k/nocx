...
| Active tab                               | `PaneManager` (`panes.ts:550`, `activePane`)                              | Frontend (PaneManager) — one activation, decided at boot             | UI-state document (`activeTab`, a durable pane id) — ADR-0048                   | Process       |
