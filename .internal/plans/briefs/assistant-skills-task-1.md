...
3. .internal/plans/2026-09-01-assistant-skills.md — read the header and the
   "Global Constraints" section (lines 1-30), then "### Task 1" in full
   (lines 134-664). That is your task; it contains the code for every step.

Your bead id is nocx-rs69e. Every commit subject must end with "(nocx-rs69e)".
...
- Do not widen scope beyond Task 1. If you find a defect outside it, put it in
