...
`.wolf/hooks/` is machine-local and gitignored. After cloning, run `openwolf init --agent all` once to install the hook runtime used by the committed agent configurations.
