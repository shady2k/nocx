...
Workspace and request deltas failing validation map to `-32602`. A persisted global failing revalidation is backend state failure `-32012`. No path text crosses the wire or logs.
...
| ------------------------------------------------- | -----: | --------------------- |
| sandbox disabled                                  | -32010 | `feature-disabled`    |
| backend unavailable                               | -32011 | backend status reason |
| policy/setup/readiness/global-state failure       | -32012 | `setup-failed`        |
