...
| N02 | Create or edit a note                    | `NoteOperation`         | `assistant.ui.execute("notes.mutate")`                                  | `notes.mutate`: the explicit note id/body is persisted and read back                             |
...
| P02 | Create or edit a snippet                 | `SnippetOperation`      | `assistant.ui.execute("snippets.mutate")`                               | `snippets.mutate`: title/body changes persist by explicit id                                     |
