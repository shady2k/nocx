...
func TestParse_RejectsObsoleteNeedsReviewField(t *testing.T) {
	svc, _, _, _, _ := newFakeService()
	contents := `{"format":"nocx-backup","version":1,"createdAt":"2026-01-01T00:00:00Z","settings":{"overrides":{}},"connections":{"profiles":[{"id":"p1","type":"ssh","name":"a","needsReview":true,"options":{"host":"h"}}],"groups":[]}}`
	_, err := svc.Preview(contents, backup.RestoreMerge)
