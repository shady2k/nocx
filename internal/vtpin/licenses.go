...
// ParseLicensesDoc reads a document back. It is deliberately strict: a
// document this package cannot read is a document nobody can check, and the
// alternative — parsing loosely and checking nothing — is how a coverage test
// passes over a file that says nothing.
