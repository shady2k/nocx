...
/*
#cgo CFLAGS: -I${SRCDIR}/../../../build/libghostty-vt/vendor/linux-arm64/include
#cgo LDFLAGS: ${SRCDIR}/../../../build/libghostty-vt/vendor/linux-arm64/libghostty-vt.a -lm -lpthread
*/
import "C"
