...
3. .internal/plans/2026-09-01-assistant-skills.md — read the header and the
   "Global Constraints" section (lines 1-30), then "### Task 5" in full
   (lines 955-978). That is your task; it contains the code for every step.

Your bead id is nocx-u68z1. Every commit subject must end with "(nocx-u68z1)".
...
- Do not widen scope beyond Task 5. If you find a defect outside it, put it in
