// Package peerpin binds a caller to a process tree without treating a pid as
// a reusable identity.
package peerpin
...
var ErrGone = errors.New("peerpin: the pinned process is gone or was replaced")

// ErrChainBroken means a live caller cannot be traced to the pinned root.
var ErrChainBroken = errors.New("peerpin: ancestry to the pinned root is broken")
