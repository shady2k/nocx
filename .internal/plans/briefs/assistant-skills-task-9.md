...
3. .internal/plans/2026-09-01-assistant-skills.md — read the header and the
   "Global Constraints" section (lines 1-30), then "### Task 9" in full
   (lines 1247-1272). That is your task; it contains the code for every step.

Your bead id is nocx-r927z. Every commit subject must end with "(nocx-r927z)".
...
- Do not widen scope beyond Task 9. If you find a defect outside it, put it in
