...
| #    | Title                                                                                                                                                         | Status                                                                                                          |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- |
| 0001 | [xterm.js as the VT frontend](0001-xterm-js-as-vt-frontend.md)                                                                                                | Accepted (amended 2026-07-26; superseded by ADR-0066)                                                           |
| 0002 | [Native tabs; no embedded multiplexer](0002-native-tabs-no-embedded-multiplexer.md)                                                                           | Accepted (server-side terminal state superseded by ADR-0066)                                                    |
...
| 0008 | [Command blocks are a keyboard-first ledger, not cards](0008-command-blocks-as-a-keyboard-first-ledger.md)                                                    | Accepted (byte-blind-backend consequences superseded by ADR-0066)                                               |
| 0009 | [The frozen scrollback is DOM, and it declares its cell geometry](0009-dom-scrollback-with-explicit-cell-geometry.md)                                         | Accepted (supersedes ADR-0004 §4; serialisation superseded by ADR-0066)                                         |
...
| 0024 | [The lifecycle leaves the byte stream](0024-authenticated-shell-integration-channel.md)                                                                       | Accepted (amended 2026-08-20; establishment ack superseded by ADR-0062)                                         |
...
| 0029 | [A proposed keystroke is bound to what makes it meaningful](0029-a-keystroke-is-bound-to-what-makes-it-meaningful.md)                                         | Superseded by ADR-0067                                                                                          |
...
| 0064 | [A pane that is read may be answered](0064-a-pane-that-is-read-may-be-answered.md)                                                                            | Accepted (§1 superseded by ADR-0067)                                                                            |
...
| 0066 | [One emulator, and it is the backend's](0066-one-emulator-and-it-is-the-backends.md)                                                                          | Accepted (2026-09-12; supersedes parts of AD-1/6/9/10 and ADR-0001/2/8/9; cutover order superseded by ADR-0072) |
...
| 0071 | [A signed channel may carry what typing may not](0071-a-signed-channel-may-carry-what-typing-may-not.md)                                                      | Accepted (2026-09-18; narrows the pointer-only rule of the 2026-09-11 design to typing)                         |
| 0072 | [xterm.js is removed first, and the interval record follows the cell model](0072-xterm-is-removed-first-and-the-interval-record-follows-the-cell-model.md)    | Accepted (2026-09-21; supersedes the cutover order of ADR-0066 and the 2026-09-12 design §9)                    |
